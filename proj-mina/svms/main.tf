...
# Project: svms
# Environment: dev
# Policy Type: specific_accounts
# Accounts: ["123456789012","987654321012"]
# Additional tag: {"Team":"New Value","BKG":"true"}
terraform {
...
locals {
  bucket_name = "svms-dev-${random_string.bucket_suffix.result}"
